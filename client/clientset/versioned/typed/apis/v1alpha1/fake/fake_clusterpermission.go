...
func (c *FakeClusterPermissions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusterpermissionsResource, c.ns, name), &v1alpha1.ClusterPermission{})
...
func (c *FakeClusterPermissions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterPermissionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusterpermissionsResource, clusterpermissionsKind, c.ns, opts), &v1alpha1.ClusterPermissionList{})
...
func (c *FakeClusterPermissions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(clusterpermissionsResource, c.ns, opts))
...
func (c *FakeClusterPermissions) Create(ctx context.Context, clusterPermission *v1alpha1.ClusterPermission, opts v1.CreateOptions) (result *v1alpha1.ClusterPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusterpermissionsResource, c.ns, clusterPermission), &v1alpha1.ClusterPermission{})
...
func (c *FakeClusterPermissions) Update(ctx context.Context, clusterPermission *v1alpha1.ClusterPermission, opts v1.UpdateOptions) (result *v1alpha1.ClusterPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusterpermissionsResource, c.ns, clusterPermission), &v1alpha1.ClusterPermission{})
...
func (c *FakeClusterPermissions) UpdateStatus(ctx context.Context, clusterPermission *v1alpha1.ClusterPermission, opts v1.UpdateOptions) (*v1alpha1.ClusterPermission, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clusterpermissionsResource, "status", c.ns, clusterPermission), &v1alpha1.ClusterPermission{})
...
func (c *FakeClusterPermissions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterpermissionsResource, c.ns, listOpts)
...
func (c *FakeClusterPermissions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterpermissionsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterPermission{})
